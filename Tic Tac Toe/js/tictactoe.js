...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            //If player is equal to X the x.png is placed in html.
        ...
        if (activePlayer === 'X') {
            ...
            activePlayer = 'O';
            //If active player is antything other than X 
        } else {
...
function checkWinConditions() {
    ...
    //and 9 squares are selected, the code3 executes.
    ...
    //This function checks if array includes £ strings.
...
function audio(audioURL) {
    ...
    //Play method plays our adio sound.
    audio.play();
}
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        ...
        x = x1,
        //This variable stores temopary y axis data we update in our animation loop.
        y = y1;
    ...
    //This function clears our canvas after our win loop line is drawn.
    function clear() {
    ...
    disableClick();
    //This line plays the win spounds.
...
function resetGame() {
    ...
    for (let i = 0; i < 9; i++) {
        //This variable gets the html element of 
